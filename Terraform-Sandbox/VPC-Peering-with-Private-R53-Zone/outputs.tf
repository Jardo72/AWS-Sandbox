...
output "ec2_instance_one_private_ip" {
  value = module.ec2.ec2_instance_one_ip_address
}
...
output "ec2_instance_two_private_ip" {
  value = module.ec2.ec2_instance_two_ip_address
}
